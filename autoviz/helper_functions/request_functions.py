...
from autoviz.config import connection_settings
from autoviz.helper_functions.error_handling import ConnectionTimeout
...
class Connector:
    ...
    async def __async_scraper(self):
        ...
        timeout = aiohttp.ClientTimeout(
            total=connection_settings["CONNECTION_TIMEOUT"])
