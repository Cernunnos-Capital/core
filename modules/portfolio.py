...
TOTAL_COST_BASIS = TOTAL_MARKET_VALUE = UNREALIZED_INTRADAY_PL = TOTAL_PL_PC = 0.0
INTRADAY_PL = CASH_FLOW = NET_ASSET_VALUE = 0.0
TOP_10_HOLDINGS = STOCK_NEWS = CHART = COMPARISON = ''
BASE_RATE = 11.0
...
def get_holdings(TOTAL_COST_BASIS, TOTAL_MARKET_VALUE,
    ...
    TOTAL_PL_PC = round(TOTAL_PL_PC, 2)
...
NET_ASSET_VALUE = round(BASE_RATE + (BASE_RATE * float(TOTAL_PL_PC / 100)), 2)
